    ...
    while (passIndex < passes.length) {
        ...
        for (let i = 0; i < CARDS_PER_PAGE; i++) {
            ...
            try {
                ...
                const col = i % COLS;
                const x = PDF_MARGIN_MM + (col * SLOT_WIDTH_MM);
                const y = PDF_MARGIN_MM + (row * SLOT_HEIGHT_MM);
        ...
        for (let i = 0; i < CARDS_PER_PAGE; i++) {
            ...
            try {
                ...
                const x = PDF_MARGIN_MM + (mirroredCol * SLOT_WIDTH_MM);
                const y = PDF_MARGIN_MM + (row * SLOT_HEIGHT_MM);
...
// Alias for manual layout if needed
export const generatePassesPDF_ManualLayout = generatePassesPDF;